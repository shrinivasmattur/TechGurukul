...
export const aboutContent = {
  title: "About TechGurukul",
  subtitle: "Empowering Futures Since 2005",
  description:
    "TechGurukul is a premier engineering and technology institution established in 2005, located in Mysore, Karnataka. Affiliated with VTU Belagavi and approved by AICTE, New Delhi, our 25-acre campus features smart classrooms, advanced laboratories, and a central library with 50,000+ books.",
  highlights: [
...
export const contactInfo = {
  email: "admissions@techgurukul.edu.in",
  phone: "+91-9876543210",
  general: "info@techgurukul.edu.in",
