import { ArrowLeft, GraduationCap, Lock, Mail, Phone, User } from "lucide-react";
...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.SyntheticEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      login(data.token);
      toast.success("Account created! Welcome to TechGurukul.");
      navigate("/");
    } catch (err: any) {
    ...
    <div className="min-h-screen flex">
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-cream">
        <div className="w-full max-w-md">
          ...
          <p className="text-gray-500 mb-8">Join TechGurukul for unlimited access to AI chat & counseling calls</p>
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        ...
        <div className="absolute inset-0 bg-maroon/60 flex items-center justify-center">
          <div className="text-center text-white p-8">
            ...
            <h2 className="font-heading text-4xl font-bold mb-2">Join TechGurukul</h2>
